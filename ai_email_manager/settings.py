# """
# Django settings for ai_email_manager project.
...
# SECRET_KEY = 'django-insecure-)fn8mh5exxwgi=a4csr33f7ioqk*1!7!xz1asm-&#bk%w7r#bv'
...
# WSGI_APPLICATION = 'ai_email_manager.wsgi.application'
...
TEMPLATES = [{
    ...
    "OPTIONS": {
        "context_processors": [
            ...
            "django.contrib.auth.context_processors.auth",
            "django.contrib.messages.context_processors.messages",
            "accounts.context_processors.active_job",
        ],
    },
}]
...
# ---- Session cookie settings (works fine for OAuth redirect from Google) ----
